...
read -p " Enter the date for the backup: " date
read -p " Enter the time for the backup: " Time
	backup_file="${filename}_backup_${date} ${Time}.bak"
